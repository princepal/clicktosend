                    ...
                    <form action="{{ route('plans.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="short_description" 
                                      ...
                                      rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('short_description') }}</textarea>
